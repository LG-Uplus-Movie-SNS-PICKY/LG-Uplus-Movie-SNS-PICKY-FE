      ...
      <div css={styles.movieDetailTop()}>
        ...
        <div className="detail">
          ...
          <div className="info">
            ...
            <span>
              {movieInfo.data.movie_info.genres
                .map((genre) => {
                  return genres.find((data) => data.genreId === genre.id).name;
                })
                .join(", ")}
            </span>
          </div>
          ...
          <div className="info">
            <h3>출시년도</h3>
            <span>
              {new Date(movieInfo.data.movie_info.release_date).getFullYear() +
                "-" +
                (
                  new Date(movieInfo.data.movie_info.release_date).getMonth() +
                  1
                )
                  .toString()
                  .padStart(2, "0") +
