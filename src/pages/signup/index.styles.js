...
`;
export const progressStyle = (progress) => css `
  width: ${progress}%;
  height: 100%;
...
`;
export const block = {
    FlexBox: ({ $direction = "row", $justifyContent = "flex-start", $alignItems = "stretch", $width = "100%", $height = "auto", $margin = "0", $padding = "0", $border = "none", $borderRadius = "0", $bgColor = "transparent", $gap = "0", $pointer = false, }) => css `
    display: flex;
...
`;
export const slideContent = (step) => css `
  position: absolute;
  width: 100%;
  height: 100%;
