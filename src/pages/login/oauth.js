...
const LoginCallback = () => {
    ...
    useEffect(() => {
        ...
        axios
            ...
            if ((oAuth2Token === null || oAuth2Token === void 0 ? void 0 : oAuth2Token.access_token) &&
                (oAuth2Token === null || oAuth2Token === void 0 ? void 0 : oAuth2Token.refresh_token) &&
                (localJwtDto === null || localJwtDto === void 0 ? void 0 : localJwtDto.accessToken)) {
                // sessionStorage에 저장
    ...
    return _jsx("div", { children: "\uB85C\uADF8\uC778 \uCC98\uB9AC \uC911..." });
};
