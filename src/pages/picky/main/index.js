...
function PickyPage() {
    // Top 10 영화 -> 리액트 쿼리
    return (_jsxs(_Fragment, { children: [_jsx(SEO, { title: "PICKY: MOVIE PICKY", description: "PICKY\uC5D0 \uB4F1\uB85D\uB41C \uC601\uD654 \uD50C\uB808\uC774\uB9AC\uC2A4\uD2B8\uB97C \uD1B5\uD574 \uC6D0\uD558\uB294 \uC601\uD654\uB97C \uCC3E\uC544\uBCF4\uC138\uC694", url: "http://localhost:5173/picky" }), _jsxs("div", { css: styles.pickyPageContainer(), children: [_jsx(MovieBackdropBanner, { movie: bestMovie[0] }), _jsx(GenreTab, {}), _jsx(BsetMovieSection, { bestMovie: bestMovie }), _jsx(PlayListSection, {})] })] }));
}
