    ...
    useEffect(() => {
        ...
        function fetchAndProcessData() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                // 예외 처리
                try {
                    const response = yield RESPONSE_DATA;
                    const { userData, movieData, reviewData, movieLogData, } = response;
                    const data = [
                        {
                            listTitle: "USER",
                            listItem: [
                                {
                                    itemIcon: User,
                                    itemBgColor: "linear-gradient(180deg, #87C3E2 0%, #007BFF 100%)",
                                    itemTitle: "사용자 권환 관리",
                                    itemTotalCount: 2170,
                                ...
                                {
                                    itemIcon: ReportUser,
                                    itemBgColor: "linear-gradient(180deg, #FFC766 0%, #FFA500 100%)",
                                    itemTitle: "신고 관리",
                                    itemTotalCount: 294,
                                ...
                                },
                                {
                                    ...
                                    itemBgColor: "linear-gradient(180deg, #FF706C 0%, #E53935 100%)",
                                    itemTitle: "정지 사용자 관리",
                                    itemTotalCount: 78,
                        ...
                        },
                        {
                            ...
                            listItem: [
                                {
                                    itemIcon: Genre,
                                    itemBgColor: "linear-gradient(180deg, #D4A5F5 0%, #8E44AD 100%)",
                                    itemTitle: "장르 관리",
                                    itemTotalCount: 15,
                                ...
                                {
                                    itemIcon: Movie,
                                    itemBgColor: "linear-gradient(180deg, #F5B041 0%, #D35400 100%)",
                                    itemTitle: "영화 관리",
                                    itemTotalCount: 305,
                                ...
                                {
                                    itemIcon: PlayList,
                                    itemBgColor: "linear-gradient(180deg, #5DADE2 0%, #21618C 100%)",
                                    itemTitle: "플레이리스트 관리",
                                    itemTotalCount: 36,
                        ...
                        },
                        {
                            ...
                            listItem: [
                                {
                                    itemIcon: Review,
                                    itemBgColor: "linear-gradient(180deg, #B8E2C1 0%, #74B78D 100%)",
                                    itemTitle: "한줄평 관리",
                                    itemTotalCount: 7213,
                                ...
                                },
                                {
                                    ...
                                    itemBgColor: "linear-gradient(180deg, #FFC4C4 0%, #E57373 100%)",
                                    itemTitle: "신고 관리",
                                    itemTotalCount: 1204,
                        ...
                        },
                        {
                            ...
                            listItem: [
                                {
                                    itemIcon: MovieLog,
                                    itemBgColor: "linear-gradient(180deg, #F9E79F 0%, #F1C40F 100%)",
                                    itemTitle: "무비로그 관리",
                                    itemTotalCount: 4621,
                                ...
                                },
                                {
                                    ...
                                    itemBgColor: "linear-gradient(180deg, #FFA07A 0%, #D35400 100%)",
                                    itemTitle: "신고 관리",
                                    itemTotalCount: 2394,
