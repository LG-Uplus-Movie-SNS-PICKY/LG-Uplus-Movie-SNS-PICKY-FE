  ...
  http.patch(
    ...
    async ({ request }) => {
      ...
      const data = {
        ...
        localJwtDto: {
          accessToken: "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6MjksInJvbGUiOiJVU0VSIiwiaWF0IjoxNzM0NDkwMjI1LCJleHAiOjE3MzQ1NzY2MjV9.O3WPsYSkWM1PyTlbK2t0OyRAp8vtELxyP-PSTtEzSGU",
        },
