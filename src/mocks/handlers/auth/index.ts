  ...
  http.patch(
    ...
    async ({ request }) => {
      ...
      const data = {
        ...
        localJwtDto: {
          accessToken: "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6MTAsInJvbGUiOiJVU0VSIiwiaWF0IjoxNzM0MTA3MDMzLCJleHAiOjE3MzQxOTM0MzN9.mHVwwSjuZNexVdhNsXor-LTtupwHHUL7ZLUJqMuznms",
        },
